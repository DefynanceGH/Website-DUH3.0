...
const Heading = styled.h1`
  ${tw`text-3xl text-center lg:text-left sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-100 my-0 leading-none`}
  span {
...
const Notification = tw.span`inline-block my-4 py-1 text-gray-100 border-l-4 border-blue-500 font-medium text-2xl`;
...
border-b-0 cursor-pointer font-semibold
`;
