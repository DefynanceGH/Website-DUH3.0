...
export default () => (
  <AnimationRevealPage>
    ...
    <NavLinks tw="p-6 pl-48 mb-8 bg-primary-100 w-full">
      <PrimaryLink tw="bg-primary-600 mr-48 hover:bg-primary-500 hocus:cursor-pointer" target="_blank" href="http://portal.defynance.com/">Get an ISA Quote</PrimaryLink>
